...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v3.3.4"
  WORKING_DIRECTORY "C:/Users/Blind/Desktop/Workspace/HPRC/Ground-Station-Frontend-CPP/cmake-build-debug/_deps/imgui-glfw-glad-glm-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v3.3.4" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v3.3.4")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Blind/Desktop/Workspace/HPRC/Ground-Station-Frontend-CPP/cmake-build-debug/_deps/imgui-glfw-glad-glm-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Blind/Desktop/Workspace/HPRC/Ground-Station-Frontend-CPP/cmake-build-debug/_deps/imgui-glfw-glad-glm-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
